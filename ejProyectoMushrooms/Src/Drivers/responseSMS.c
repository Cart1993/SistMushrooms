...
switch( receiveMsj )
		{
			...
			case smsTX:
				if( alertaHumLow == 1 )
				{
					...
					Send( numeroTelefonicoAlertas, alertaHumBaja );
				}
				if( alertaTempLow == 1 )
				{
					CMGD( "1" , "4" );
					...
					Send( numeroTelefonicoAlertas, alertaTempBaja );
				}
				if( alertaTempHigh == 1 )
				{
					CMGD( "1" , "4" );
					...
					Send( numeroTelefonicoAlertas, alertaTempAlta );
				}
				if( alertaTempMcuHigh == 1 )
				{
					CMGD( "1" , "4" );
					HAL_Delay( 2000 );
					for( uint8_t x=0 ; x<100; x++)
					...
					Send( numeroTelefonicoAlertas, alertaTempMCU );
				}
				break;
		}
}
